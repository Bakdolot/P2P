...
class Trade(models.Model):
    ...
    sell_quantity = models.DecimalField('Сумма продаваемой крипты', max_digits=19, decimal_places=6)
    buy_quantity = models.DecimalField('Сумма покупаемой крипты', max_digits=19, decimal_places=6)
